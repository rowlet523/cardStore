...
public class PorderSuccessUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PorderSuccessUI  frame = new PorderSuccessUI ();
	...
	public PorderSuccessUI () {
		...
		JLabel addLabel = new JLabel("<html><a href=''>繼續購物</a></html>");
		...
		JLabel successLabel = new JLabel("訂單成立!!");
		successLabel.setFont(new Font("新宋体", Font.BOLD, 20));
		successLabel.setBounds(126, 34, 116, 33);
